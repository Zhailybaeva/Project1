...
class OnBoardingScreenFiveth extends StatefulWidget {
  final PageController controller;

  const OnBoardingScreenFiveth({super.key, required this.controller});

  @override
  State<OnBoardingScreenFiveth> createState() => _OnBoardingScreenFivethState();
}

class _OnBoardingScreenFivethState extends State<OnBoardingScreenFiveth>
  ...
  PageViewOnBoarding onBoarding = const PageViewOnBoarding();
  ...
  void initState() {
    ...
    _flowerAnimation = Tween<Offset>(
      begin: const Offset(0.21, -0.015), // Starting position off-screen
      end: const Offset(0.21, -0.03), // Ending position on-screen
    ...
    _dropAnimation = Tween<Offset>(
      begin: const Offset(0.17, 0.17), // Starting position off-screen
            ...
            AnimatedBuilder(
              ...
              builder: (BuildContext context, Widget? child) {
                return Positioned(
                  ...
                  child:
                      SvgPicture.asset('images/geometric_figures/drop.svg'),
                );
              },
            ),
            AnimatedBuilder(
              ...
              builder: (BuildContext context, Widget? child) {
                return Positioned(
                  ...
                  child:
                      SvgPicture.asset('images/geometric_figures/star.svg'),
                );
              },
            ),
            Column(
                ...
                Column(
                  children: [
                    ...
                    Container(
                      ...
                      child: Text(
                        S.of(context).StreamingLessonsText,
                        textAlign: TextAlign.center,
                        style: TextStyle(
                          color: Colors.white,
                          fontSize: 20.sp,
