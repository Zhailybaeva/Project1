...
class OnBoardingScreenSecond extends StatefulWidget {
  ...
  const OnBoardingScreenSecond({super.key, required this.controller});
...
class _OnBoardingScreenSecondState extends State<OnBoardingScreenSecond>
  ...
  void initState() {
    ...
    _flowerAnimation = Tween<Offset>(
      begin: const Offset(0.15, 0.035), // Starting position off-screen
      end: const Offset(0.18, 0.02), // Ending position on-screen
    ...
    _dropAnimation = Tween<Offset>(
      begin: const Offset(0.57, 0.15), // Starting position off-screen
      end: const Offset(0.4, 0.17), // Ending position on-screen
    ).animate(CurvedAnimation(
      parent: _controller,
      curve: Curves.easeInOut, // Adjust the curve as needed
    ));
    ...
    _starAnimation = Tween<Offset>(
      begin: const Offset(0.08, 0.48), // Starting position off-screen
      end: const Offset(0.18, 0.45), // Ending position on-screen
    ).animate(CurvedAnimation(
      parent: _controller,
      curve: Curves.easeInOut, // Adjust the curve as needed
    ));
                ...
                Column(
                  children: [
                    ...
                    Container(
                      ...
                      child: Text(
                        S.of(context).DistanceLearningText,
                        textAlign: TextAlign.center,
                        style: TextStyle(
                          color: Colors.white,
                          fontSize: 20.sp,
