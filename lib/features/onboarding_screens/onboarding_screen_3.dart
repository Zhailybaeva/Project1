...
class OnBoardingScreenThird extends StatefulWidget {
  ...
  const OnBoardingScreenThird({super.key, required this.controller});
...
class _OnBoardingScreenThirdState extends State<OnBoardingScreenThird>
  ...
  void initState() {
    ...
    _flowerAnimation = Tween<Offset>(
      begin: const Offset(0.18, 0.02), // Starting position off-screen
      end: const Offset(0.21, 0.0), // Ending position on-screen
    ...
    _dropAnimation = Tween<Offset>(
      begin: const Offset(0.4, 0.17), // Starting position off-screen
      end: const Offset(0.3, 0.2), // Ending position on-screen
    ).animate(CurvedAnimation(
      parent: _controller,
      curve: Curves.easeInOut, // Adjust the curve as needed
    ));
    ...
    _starAnimation = Tween<Offset>(
      ...
      end: const Offset(0.2, 0.4), // Ending position on-screen
    ).animate(CurvedAnimation(
      parent: _controller,
      curve: Curves.easeInOut, // Adjust the curve as needed
    ));
                ...
                Column(
                  children: [
                    ...
                    Container(
                      ...
                      child: Text(
                        S.of(context).LessonMaterialstext,
                        textAlign: TextAlign.center,
                        style: TextStyle(
                          color: Colors.white,
                          fontSize: 20.sp,
